...
author:
  - name: "Ben Dêivide"
    ...
    affiliation: UFSJ
    affiliation_url: https://ufsj.edu.br/
    orcid_id: 0000-0001-7019-8794
...
# Sumário {#sumario}
- [<i class="fas fa-book"></i> Livro do Curso](#book)
...
<center>
[![](images/book-eambr.png)](https://bendeivide.github.io/book-eambr/){target='_blank'}
</center>
...
Para saber mais sobre o autor, veja a seção [autor](about.html), na barra de navegação da página, ou acesse minha página [pessoal/profissional]
...
Para acessar o material, segue: [Programação em `R` (Nível Intermediário)](nintermediario.html).
...
Citaremos alguns livros e materiais utilizados para o desenvolvimento desse curso, tais como:
 ...
 - Statistical Models in S [@chambers1993]
