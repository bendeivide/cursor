...
Para a instalação do `R` e do [RStudio](http://rstudio.org/), como também do [rtools](https://cran.r-project.org/bin/windows/Rtools/), convidaremos para a seção [Instalação do R e do RStudio](nbasico.html#r-rstudio-rtools) do primeiro módulo desse curso, que é [Programação em R (nível básico)](nbasico.html)
