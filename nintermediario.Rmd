...
- [<i class="fab fa-connectdevelop"></i> Programação Funcional](#prog_funcional)
  ...
  <!-- Levar em consideração a crítica de que muitos cursos que introduzem o curso R usam pacotes da familia tidyverse, -->
  <!-- de modo que representa uma nova sintaxe para o R, -->
  <!-- perdendo fundamentos de estruturas basicas como -->
  <!-- os vetores, atribuicoes. Isso pq o estilo é praticamente funcional. Para uma melhor discussao, acessar: -->
