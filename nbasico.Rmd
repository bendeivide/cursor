...
Observe que o último componente é o ambiente onde o nome `fun1` foi associado a função. Este ambiente é chamado de **ambiente de funções**. Nesse caso é o ambiente global. Contudo, quando a função é executada, momentaneamente é criado o **ambiente de execuções**. É nesse ambiente que os nomes que estão no corpo da função são associados aos objetos. Vejamos um primeiro exemplo,
