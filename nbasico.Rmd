...
## Slides de Aulas {#slidesaulas}
 ...
 - Aula 06: [Arquivos `.RData` e `.Rhistory`](index.html)
 - Aula 07: [Criando e salvando um *Script*](index.html)
 - Aula 08: [Exportando dados](index.html)
 - Aula 09: [Objetos](index.html)
 - Aula 10: [Vetores](index.html)
 - Aula 11: [Matrizes](index.html)
 - Aula 12: [*Arrays*](index.html)
 - Aula 13: [*Data frames*](index.html)
 - Aula 14: [*Lists*](index.html)
...
Ao final do que falamos até agora, todo o processo ao inserir linhas de comando do console, e desejarmos finalizar os trabalhos do ambiente `R`, dois arquivos são criados, sob a instrução do usuário em querer aceitar ou não, que é a criação de dois arquivos *.RData* e *.Rhistory*, cujas finalidades são:
