...
## Scripts {#scripts}
 ...
 - [Script 08](scripts/aula08/script08.R){target="_blank"}: [Script08.txt](scripts/aula08/script08_2.txt){target="_blank"}; [Script 08_2](scripts/aula08/script08_2.R){target="_blank"}: [Script08_2.txt](scripts/aula08/script08_2.txt){target="_blank"}
 - [Script 09](scripts/aula09/script09.R){target="_blank"}: [Vetores](scripts/aula09/script09.txt){target="_blank"}
 - [Script 10](scripts/aula10/script10.R){target="_blank"}: [Matrizes bidimensionais](scripts/aula10/script10.txt){target="_blank"}
 - [Script 11](scripts/aula11/script11.R){target="_blank"}: [Matrizes multidimensionais](scripts/aula11/script11.txt){target="_blank"}
 - Script 12:
 - Script 13:
 - Script 14:
 - Script 15:
