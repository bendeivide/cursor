...
## Slides de Aulas {#slidesaulas}
 ...
 - Aula 04: [Como o R trabalha](aulas/aula04.html)
 - Aula 05: [Comandos no R e Ambiente Global](aulas/aula05.html)
 - Aula 06: [Arquivos `.RData` e `.Rhistory`](aulas/aula06.html)
 - Aula 07: [Criando e salvando um *Script*](aulas/aula07.html)
 - Aula 08: [Objetos](index.html)
 - Aula 09: [Aritmética e Operadores lógicos](index.html)
 - Aula 09: [Vetores](index.html)
 - Aula 10: [Matrizes](index.html)
 - Aula 11: [*Arrays*](index.html)
 - Aula 12: [*Data frames*](index.html)
 - Aula 13: [*Lists*](index.html)
 - Aula 14: [Importando/Exportando dados](index.html)
 - Aula 15: [Funções](index.html)
 - Aula 16: ~
 - Aula 17: [Boas práticas de como escrever um código](index.html)
...
## Scripts {#scripts}
 ...
 - Script 04: ~
 - [Script 05](scripts/script05.txt): [Comandos](scripts/script05.R) 
 - Script 06: ~
 - [Script 07](https://github.com/bendeivide/cursor/blob/master/scripts/aula07/Aula07-primeiro_script.R): [.RData e .Rhistory](https://github.com/bendeivide/cursor/blob/master/scripts/aula07/Aula07-primeiro_script.R)
 - Script 08:
 - Script 09:
 - Script 10:
...
O diagrama explica que o nome criado "`x`" se associou com um objeto do **tipo** (estrutura) vetor e **modo** `numeric` (ou também  `double`, usando a função `typeof()`). Essa outra representação ficará mais claro, no segundo diagrama, Figura \@ref(fig:objxy), que representa a ligação do nome "`y`" ao objeto.
...
```{r segundo_codigo, echo=TRUE, , prompt=TRUE}
y <- x
lobstr::obj_addr(y)
# [1] "0xf8a104fc20"
```

```{r objxy, fig.cap = "Dizemos que o nome `'x'` se liga ao objeto do tipo (estrutura) vetor.", fig.height= 6, fig.width=9, fig.align='center'}
...
<!--
# <i class="fas fa-file-export"></i> Importantdo/Exportando dados {#exportdata}
