...
```{r chambers, fig.cap = "John Chambers^[Fonte da foto: Retirada de sua página pessoal, [https://statweb.stanford.edu/~jmc4/](https://statweb.stanford.edu/~jmc4/)], o criador da linguagem `S`.", out.width="10%", fig.align='center'}
...
# <i class="fas fa-file-code"></i> Boas práticas de como escrever um código
